...
- Always fetch the latest filings, earnings materials, and social or news context at run time.
- Do not rely on cached sentiment snapshots or stale fundamentals.
- Re-check both the fundamentals and sentiment sources every time.

## Data Source Priority

- Tier 1 for fundamentals: `10-K`, `10-Q`, earnings releases, and earnings transcripts
- Tier 2 for sentiment: `Twitter` and `Reddit`
- Sentiment is a deviation indicator only, not the decision rule by itself.
