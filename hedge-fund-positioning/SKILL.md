...
- Always fetch the latest available 13F cycle directly at run time.
- Do not reuse cached fund-change tables or stale quarter labels.
- Reconfirm both the latest reporting quarter and the prior comparison quarter each run.

## Data Source Priority

- Tier 1: `SEC 13F` filings
- Tier 2: `WhaleWisdom`, `Dataroma`
- Use aggregators to speed discovery, but confirm with SEC filings whenever possible.
